# Writing final full featured main.py and zipping project for user (visible output).
import os, json, zipfile, textwrap, shutil
from datetime import datetime

work = "/mnt/data/boss-helper-final"
dst = "/mnt/data/boss-helper-final.zip"
...
with open(os.path.join(work, "Procfile"), "w", encoding="utf-8") as f:
...
with open(os.path.join(work, "database.json"), "w", encoding="utf-8") as f:
    json.dump(db, f, ensure_ascii=False, indent=2)

with open(os.path.join(work, "README.md"), "w", encoding="utf-8") as f:
    f.write("Boss helper final - deploy with LINE keys in environment variables.\n")
